...
// console.log(unisWithUni.map((uni) => uni.university));
...
// console.log(lowPopulationAnimals.map((animal) => animal.animal_name))
...
*/
const populationTotal = zooAnimals.reduce((totalPop, curAnimal) => totalPop += curAnimal.population, 0);
